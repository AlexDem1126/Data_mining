...
public class Naive_Bayes_with_Laplace_Smoothing {
	...
	public Naive_Bayes_with_Laplace_Smoothing(double[] trueGradeMF, double[][] datasetMF, int numOfPointsMF, int numOfDimensionMF) {
//		double[] trueGrade = trueGradeMF;		
		dataset = datasetMF;
...
//			System.out.println(i+" true:"+trueGradeTraining[i]+", predicted:"+largestTrainingPredicted[i]+": "+nornilezed90Plus+", " + nornilezed90Minus);			
	...
	private void countTP_FP_FN_TN() {
		...
		System.out.println("TRAINING: TP= "+TP + ", FP= "+FP + ", FN= "+FN + ", TN= " + TN);
	}
